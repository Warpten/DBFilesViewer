...
namespace BrightIdeasSoftware
{
    ...
    /// </remarks>
    public class DataListView<T> : ObjectListView<T>
    {
        ...
        public DataListView()
        {
            this.Adapter = new DataSourceAdapter<T>(this);
        }
        ...
        /// <para>When a DataSource is set, the control will create OLVColumn{T}s to show any
        ...
        /// </remarks>
        protected DataSourceAdapter<T> Adapter {
            get {
