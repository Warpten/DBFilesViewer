...
namespace BrightIdeasSoftware
{
    ...
    public interface IDragSource<T>
    {
        ...
        Object StartDrag(ObjectListView<T> olv, MouseButtons button, OLVListItem<T> item);
    ...
    /// </summary>
    public class AbstractDragSource<T> : IDragSource<T>
    {
        ...
        /// <returns></returns>
        public virtual Object StartDrag(ObjectListView<T> olv, MouseButtons button, OLVListItem<T> item) {
            return null;
        }
    ...
    public class SimpleDragSource<T> : IDragSource<T>
    {
        #region Constructors
