 ...
 *                  - Uses OLVColumn<T>.HeaderTextAlign to decide how to align the column's header
...
namespace BrightIdeasSoftware {
    ...
    /// control.
    /// </summary>
    public class HeaderControl<T> : NativeWindow {
        /// <summary>
        /// Create a header control for the given ObjectListView.
        /// </summary>
        /// <param name="olv"></param>
        public HeaderControl(ObjectListView<T> olv) {
            ListView = olv;
        ...
        /// </summary>
        protected ObjectListView<T> ListView { get; set; }
        ...
        /// </summary>
        public ToolTipControl<T> ToolTip {
            get {
                if (toolTip == null) {
                    CreateToolTip();
                }
        ...
        private ToolTipControl<T> toolTip;
        ...
        private float CalculateColumnHeight(Graphics g, OLVColumn<T> column, TextFormatFlags flags, bool isHot, int i) {
        ...
        /// <returns></returns>
        public Rectangle GetCheckBoxBounds(OLVColumn<T> column) {
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        public bool HasCheckBox(OLVColumn<T> column) {
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        protected bool HasSortIndicator(OLVColumn<T> column) {
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        protected bool HasFilterIndicator(OLVColumn<T> column) {
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        protected bool HasNonThemedSortIndicator(OLVColumn<T> column) {
            if (!ListView.ShowSortIndicators)
                return false;
        ...
        /// </summary>
        public void Invalidate(OLVColumn<T> column) {
        ...
        private bool HandleReflectNotify(ref Message m)
        {
            ...
            System.Diagnostics.Debug.WriteLine("rn: {0}", nmhdr.code);
            return true;
        }
                ...
                case CDDS_ITEMPREPAINT:
                    ...
                    if (cachedNeedsCustomDraw) {
                        using (var g = Graphics.FromHdc(nmcustomdraw.hdc)) {
                            g.TextRenderingHint = ObjectListView<T>.TextRenderingHint;
        ...
        /// <param name="column"></param>
        /// <param name="stateStyle"></param>
        protected void DrawHeaderImageAndText(Graphics g, Rectangle r, OLVColumn<T> column, HeaderStateStyle stateStyle) {
        ...
        private void DrawText(Graphics g, Rectangle r, OLVColumn<T> column, TextFormatFlags flags, Font f, Color color) {
            if (column.ShowTextInHeader)
                TextRenderer.DrawText(g, column.Text, f, r, color, Color.Transparent, flags);
        }

        private void DrawImageAndText(Graphics g, Rectangle r, OLVColumn<T> column, TextFormatFlags flags, Font f,
        ...
        private static void DrawVerticalText(Graphics g, Rectangle r, OLVColumn<T> column, Font f, Color color) {
            try {
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        protected HeaderFormatStyle CalculateHeaderStyle(OLVColumn<T> column) {
        ...
        /// <param name="isPressed"></param>
        /// <returns></returns>
        protected HeaderStateStyle CalculateStateStyle(OLVColumn<T> column, bool isHot, bool isPressed) {
        ...
        /// <param name="isPressed"></param>
        /// <returns></returns>
        protected Font CalculateFont(OLVColumn<T> column, bool isHot, bool isPressed) {
            var stateStyle = CalculateStateStyle(column, isHot, isPressed);
        ...
        internal OlvListViewHitTestInfo<T>.HeaderHitTestInfo HitTest(int x, int y)
        {
            ...
            var hti = new OlvListViewHitTestInfo<T>.HeaderHitTestInfo();
