 ...
 * v2.5.1
 * 2012-04-26   JPP  - Filter group events from TreeListView<T> since it can't have groups
...
namespace BrightIdeasSoftware.Design
{
    ...
    public class ObjectListViewDesigner : ControlDesigner
    {
        ...
        protected override void PreFilterProperties(IDictionary properties) {
            ...
            if (Control.GetType().GetGenericTypeDefinition() == typeof(TreeListView<>))
            {
        ...
        protected override void PreFilterEvents(IDictionary events) {
            ...
            {
                var eventDesc = TypeDescriptor.CreateEvent(typeof(IObjectListView),
                    (EventDescriptor)events[unwantedEvent], new BrowsableAttribute(false));
        ...
        private class ListViewActionListAdapter : DesignerActionList
        {
            ...
            private void EditValue(ComponentDesigner componentDesigner, IComponent iComponent, string propertyName) {
                ...
                tEditorServiceContext?.InvokeMember("EditValue",
                    BindingFlags.InvokeMethod | BindingFlags.Static, null, null, new object[] { componentDesigner, iComponent, propertyName });
            }
            ...
            public void InvokeColumnsDialog() {
                EditValue(_designer, Component, "Columns");
            }
            ...
            private ObjectListViewDesigner _designer;
    ...
    public class OLVColumnCollectionEditor : CollectionEditor
    {
        ...
        /// </summary>
        public OLVColumnCollectionEditor()
            : base(typeof(object)) {
        }
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
            ...
            olv.Columns.Clear();
            olv.Columns.AddRange(newColumns.Cast<ColumnHeader>().ToArray());
    ...
    internal class OverlayConverter : ExpandableObjectConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            ...
            var imageOverlay = value as IImageAdornment;
            if (imageOverlay != null)
                return imageOverlay.Image == null ? "(none)" : "(set)";

            var textOverlay = value as ITextAdornment;
            if (textOverlay != null)
