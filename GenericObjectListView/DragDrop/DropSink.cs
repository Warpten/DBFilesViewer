...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    public class AbstractDropSink<T> : IDropSink<T>
    {
        #region Commands
    ...
    /// </remarks>
    public class SimpleDropSink<T> : AbstractDropSink<T>
    {
        private ModelDropEventArgs<T> dropEventArgs;
        ...
        public SimpleDropSink()
        {
            ...
            Billboard = new BillboardOverlay<T>();
        }
        ...
        public BillboardOverlay<T> Billboard { get; set; }
        ...
        /// </summary>
        public OLVListItem<T> DropTargetItem => ListView.GetItem(DropTargetIndex);
        ...
        {
            g.SmoothingMode = ListView.SmoothingMode;
        ...
        public override void Enter(DragEventArgs args)
        {
            ...
            dropEventArgs = new ModelDropEventArgs<T>
            {
                DropSink = this,
                ListView = ListView,
                DragEventArgs = args,
            ...
            var olvData = args.Data as OLVDataObject<T>;
            if (olvData != null)
            {
        ...
        protected virtual void CalculateDropTarget(OlvDropEventArgs<T> args, Point pt)
        {
        ...
        /// </summary>
        /// <param name="args"></param>
        protected virtual void UpdateAfterCanDropEvent(OlvDropEventArgs<T> args)
        {
        ...
        /// <returns></returns>
        protected virtual Rectangle CalculateDropTargetRectangle(OLVListItem<T> item, int subItem)
        {
            if (subItem > 0)
    ...
    ///     </para>
    /// </remarks>
    public class RearrangingDropSink<T> : SimpleDropSink<T>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="args"></param>
        protected override void OnModelCanDrop(ModelDropEventArgs<T> args)
        {
        ...
        /// </summary>
        /// <param name="args"></param>
        protected override void OnModelDropped(ModelDropEventArgs<T> args)
        {
        ...
        /// </summary>
        /// <param name="args"></param>
        public virtual void RearrangeModels(ModelDropEventArgs<T> args)
        {
    ...
    /// </summary>
    public class OlvDropEventArgs<T> : EventArgs
    {
        ...
        /// </summary>
        public SimpleDropSink<T> DropSink { get; internal set; }
        ...
        ///     Get the item that is the target of the drop
        /// </summary>
        public OLVListItem<T> DropTargetItem
        {
    ...
    /// </summary>
    public class ModelDropEventArgs<T> : OlvDropEventArgs<T>
    {
        private IList<T> dragModels;
        private IList<T> toBeRefreshed = new List<T>();

        /// <summary>
        ///     Gets the model objects that are being dragged.
        /// </summary>
        public IList<T> SourceModels
        {
            get { return dragModels; }
            internal set
            {
                dragModels = value;
                var tlv = SourceListView as TreeListView<T>;
                if (tlv != null)
                {
        ...
        public T TargetModel { get; internal set; }
        ...
        {
            ((List<T>) toBeRefreshed).AddRange(SourceModels);
            var tlv = SourceListView as TreeListView<T>;
            if (tlv == null)
            ...
            var tlv2 = ListView as TreeListView<T>;
            if (tlv2 == null)
