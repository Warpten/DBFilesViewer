/*
 * DataTreeListView<T> - A data bindable TreeListView
 *
...
namespace BrightIdeasSoftware
{
    ...
    /// </remarks>
    public partial class DataTreeListView<T> : TreeListView<T>
    {
        ...
        /// for data binding.
        /// </summary>
        protected TreeDataSourceAdapter<T> Adapter {
            get {
                if (this.adapter == null)
                    this.adapter = new TreeDataSourceAdapter<T>(this);
                return adapter;
            }
            set { adapter = value; }
        }
        private TreeDataSourceAdapter<T> adapter;
