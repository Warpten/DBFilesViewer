...
namespace BrightIdeasSoftware
{
    ...
    public interface IVirtualListDataSource<T>
    {
        /// <summary>
        ...
        int SearchText(string value, int first, int last, OLVColumn<T> column);
        ...
        void Sort(OLVColumn<T> column, SortOrder order);
        ...
        void AddObjects(ICollection<T> modelObjects);
        ...
        /// <param name="modelObjects">A collection of model objects</param>
        void InsertObjects(int index, ICollection<T> modelObjects);

        /// <summary>
        /// Remove all of the given objects from the control
        /// </summary>
        /// <param name="modelObjects">Collection of objects to be removed</param>
        void RemoveObjects(ICollection<T> modelObjects);

        /// <summary>
        /// Set the collection of objects that this control will show.
        /// </summary>
        /// <param name="collection"></param>
        void SetObjects(IEnumerable<T> collection);
        ...
        void UpdateObject(int index, T modelObject);
    }
    ...
    public interface IFilterableDataSource<T>
    {
        ...
        void ApplyFilters(IModelFilter<T> modelFilter, IListFilter<T> listFilter);
    }

    /// <summary>
    /// A do-nothing implementation of the VirtualListDataSource interface.
    /// </summary>
    public class AbstractVirtualListDataSource<T> : IVirtualListDataSource<T>, IFilterableDataSource<T>
    {
        /// <summary>
        /// Creates an AbstractVirtualListDataSource
        /// </summary>
        /// <param name="listView"></param>
        public AbstractVirtualListDataSource(VirtualObjectListView<T> listView) {
        ...
        /// </summary>
        protected VirtualObjectListView<T> listView;
        ...
        /// <param name="index"></param>
        /// <param name="modelObject"></param>
        public virtual void UpdateObject(int index, T modelObject) {
        }
        ...
        /// <param name="modelFilter"></param>
        /// <param name="listFilter"></param>
        virtual public void ApplyFilters(IModelFilter<T> modelFilter, IListFilter<T> listFilter) {
        }
    ...
    public class VirtualListVersion1DataSource<T> : AbstractVirtualListDataSource<T>
    {
        ...
        /// </summary>
        /// <param name="listView"></param>
        public VirtualListVersion1DataSource(VirtualObjectListView<T> listView)
            : base(listView) {
        }
        ...
        /// </summary>
        public RowGetterDelegate<T> RowGetter {
            get { return rowGetter; }
            set { rowGetter = value; }
        }
        private RowGetterDelegate<T> rowGetter;
        ...
        /// <param name="column"></param>
        /// <returns></returns>
        public override int SearchText(string value, int first, int last, OLVColumn<T> column) {
