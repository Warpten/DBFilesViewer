...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    public class TintedColumnDecoration<T> : AbstractDecoration<T>
    {
        #region Constructors
        ...
        public TintedColumnDecoration(OLVColumn<T> column)
            : this() {
            ColumnToTint = column;
        }
        ...
        /// </summary>
        public OLVColumn<T> ColumnToTint { get; set; }
    ...
    /// </summary>
    public class BorderDecoration<T> : AbstractDecoration<T>
    {
        #region Constructors
    ...
    /// </summary>
    public class RowBorderDecoration<T> : BorderDecoration<T>
    {
        /// <summary>
    ...
    /// </summary>
    public class CellBorderDecoration<T> : BorderDecoration<T>
    {
        /// <summary>
        /// Calculate the boundaries of the border
        /// </summary>
    ...
    /// </summary>
    public class EditingCellBorderDecoration<T> : BorderDecoration<T>
    {
    ...
    /// </summary>
    public class LightBoxDecoration<T> : BorderDecoration<T>
    {
        /// <summary>
    ...
    /// </summary>
    public class ImageDecoration<T> : ImageAdornment<T>, IDecoration<T>
    {
        #region Constructors
    ...
    /// </summary>
    public class TextDecoration<T> : TextAdornment<T>, IDecoration<T>
    {
        #region Constructors
