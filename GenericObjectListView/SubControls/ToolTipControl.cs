...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    public class ToolTipControl<T> : NativeWindow
    {
        #region Constants
        ...
        public bool IsBalloon {
            ...
            set {
                ...
                if (value) {
                    ...
                    if (!ObjectListView<T>.IsVistaOrLater)
        ...
        public virtual bool HandleGetDispInfo(ref Message msg) {
            ...
            SetMaxWidth();
            var args = new ToolTipShowingEventArgs<T>();
        ...
        private void ApplyEventFormatting(ToolTipShowingEventArgs<T> args) {
        ...
        /// </summary>
        public event EventHandler<ToolTipShowingEventArgs<T>> Showing;
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnShowing(ToolTipShowingEventArgs<T> e) {
            if (Showing != null)
                Showing(this, e);
        }
