/*
 * OLVListSubItem<T> - A single cell in an ObjectListView
 *
...
namespace BrightIdeasSoftware {
    ...
    /// </summary>
    [Browsable(false)]
    public class OLVListSubItem<T> : ListViewItem.ListViewSubItem {
        #region Constructors
        ...
        /// </summary>
        internal ImageRenderer<T>.AnimationState AnimationState;
