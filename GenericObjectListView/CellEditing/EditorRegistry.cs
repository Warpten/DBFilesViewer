 ...
 *
 * Change log:
 * 2011-03-31  JPP  - Use OLVColumn<T>.DataType if the value to be edited is null
...
namespace BrightIdeasSoftware {
    ...
    public delegate Control EditorCreatorDelegate(object model, OLVColumn<object> column, object value);
    ...
    public class EditorRegistry {
        ...
        private void InitializeStandardTypes() {
            ...
            Register(typeof(bool), delegate(object model, OLVColumn<object> column, object value) {
        ...
        public void Register(Type type, Type controlType) {
            Register(type, (model, column, value) => controlType.InvokeMember("", BindingFlags.CreateInstance, null, null, null) as Control);
        }

        private void Register(Type type, EditorCreatorDelegate del) => creatorMap[type] = del;
        ...
        public Control GetEditor<T>(T model, OLVColumn<T> column, object value) {
            Control editor;

            // Give the first chance delegate a chance to decide
            if (firstChanceCreator != null) {
                editor = firstChanceCreator(model, column as OLVColumn<object>, value);
                if (editor != null)
                    return editor;
            }
            ...
            if (defaultCreator != null)
                return defaultCreator(model, column as OLVColumn<object>, value);
