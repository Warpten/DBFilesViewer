...
{
    public enum SamplerFlagType : uint
    {
        WrapBoth = 3,
        WrapU = 1,
        WrapV = 2,
    ...
    public class Texture : IDisposable
    {
        ...
        public int Width => mTexture.Description.Width;
        public int Height => mTexture.Description.Height;
        public bool IsHighDefinition => Width != Height;
        ...
        public void LoadFromLoadInfo(TextureLoadInfo loadInfo)
        {
