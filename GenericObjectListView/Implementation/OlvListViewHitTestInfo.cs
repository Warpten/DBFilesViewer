...
namespace BrightIdeasSoftware {
    ...
    public class OlvListViewHitTestInfo<T>
    {

        /// <summary>
        /// Create a OlvListViewHitTestInfo
        /// </summary>
        public OlvListViewHitTestInfo(OLVListItem<T> olvListItem, OLVListSubItem<T> subItem, int flags, int iColumn)
        {
            Item = olvListItem;
            SubItem = subItem;
            ...
            ColumnIndex = iColumn;
            ListView = (ObjectListView<T>) olvListItem?.ListView;
        ...
        /// </summary>
        public OlvListViewHitTestInfo(ObjectListView<T> olv, int iColumn, bool isOverCheckBox, int iDivider) {
            ListView = olv;
            ColumnIndex = iColumn;
        ...
        private static ListViewHitTestLocations ConvertNativeFlagsToDotNetLocation(OLVListItem<T> hitItem, int flags)
        {
        ...
        {
            return
                $"HitTestLocation: {HitTestLocation}, HitTestLocationEx: {HitTestLocationEx}, Item: {Item}, SubItem: {SubItem}, Location: {Location}, ColumnIndex: {ColumnIndex}";
        }
