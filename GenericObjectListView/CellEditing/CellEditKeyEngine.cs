...
namespace BrightIdeasSoftware {
    ...
    /// </summary>
    public class CellEditKeyEngine<T>
    {
        ...
        public virtual bool HandleKey(ObjectListView<T> olv, Keys keyData) {
        ...
        /// </summary>
        protected OLVListItem<T> ItemBeingEdited => ListView?.CellEditEventArgs?.ListViewItem;

        /// <summary>
        /// Gets the index of the column of the cell that is being edited
        /// </summary>
        protected int SubItemIndexBeingEdited => ListView?.CellEditEventArgs?.SubItemIndex ?? -1;
        ...
        protected void StartCellEditIfDifferent(OLVListItem<T> olvi, int subItemIndex) {
        ...
        protected OLVListItem<T> GetAdjacentItem(OLVListItem<T> olvi, bool up) {
