 ...
 * 2010-03-09   JPP  - Correctly Unbind() when the related ObjectListView<T> is disposed.
...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    internal class GlassPanelForm<T> : Form
    {
        ...
        /// </summary>        
        public void Bind(ObjectListView<T> olv, IOverlay<T> overlay) {
            ...
            foreach (var ancestor in ancestors) {
                ancestor.ParentChanged += objectListView_ParentChanged;
        ...
        public void Unbind() {
            ...
            if (myOwner != null) {
                myOwner.LocationChanged -= Owner_LocationChanged;
                myOwner.SizeChanged -= Owner_SizeChanged;
                myOwner.ResizeBegin -= Owner_ResizeBegin;
                myOwner.ResizeEnd -= Owner_ResizeEnd;
                myOwner = null;
            }
        ...
        internal void UpdateTransparency() {
            var transparentOverlay = Overlay as ITransparentOverlay<T>;
