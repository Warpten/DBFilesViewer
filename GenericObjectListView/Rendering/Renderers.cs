...
namespace BrightIdeasSoftware {
    ...
    public interface IRenderer<T>
    {
        ...
        /// <param name="rowObject">The model object to be drawn</param>
        /// <returns>Return true to indicate that the event was handled and no further processing is needed.</returns>
        bool RenderSubItem(DrawListViewSubItemEventArgs e, Graphics g, Rectangle cellBounds, T rowObject);
        ...
        void HitTest(OlvListViewHitTestInfo<T> hti, int x, int y);
        ...
        /// <returns></returns>
        Rectangle GetEditRectangle(Graphics g, Rectangle cellBounds, OLVListItem<T> item, int subItemIndex, Size preferredSize);
    }
    ...
    [Browsable(true),
     ToolboxItem(false)]
    public class AbstractRenderer<T> : Component, IRenderer<T>
    {
        ...
        /// <param name="rowObject">The model object to be drawn</param>
        /// <returns>Return true to indicate that the event was handled and no further processing is needed.</returns>
        public virtual bool RenderItem(DrawListViewItemEventArgs e, Graphics g, Rectangle itemBounds, T rowObject) {
            return true;
        }
        ...
        /// <param name="rowObject">The model object to be drawn</param>
        /// <returns>Return true to indicate that the event was handled and no further processing is needed.</returns>
        public virtual bool RenderSubItem(DrawListViewSubItemEventArgs e, Graphics g, Rectangle cellBounds, T rowObject) {
            return false;
        }
        ...
        /// <param name="y">y co-ordinate</param>
        /// <remarks>This method should only alter HitTestLocation and/or UserData.</remarks>
        public virtual void HitTest(OlvListViewHitTestInfo<T> hti, int x, int y) {}
        ...
        /// <param name="preferredSize"> </param>
        /// <returns></returns>
        public virtual Rectangle GetEditRectangle(Graphics g, Rectangle cellBounds, OLVListItem<T> item, int subItemIndex, Size preferredSize) {
            return cellBounds;
        }
    ...
    /// </summary>
    [ToolboxItem(false)]
    internal class Version1Renderer<T> : AbstractRenderer<T>
    {
        public Version1Renderer(RenderDelegate<T> renderDelegate) {
        ...
        /// </summary>
        public RenderDelegate<T> RenderDelegate;

        #region IRenderer Members

        public override bool RenderSubItem(DrawListViewSubItemEventArgs e, Graphics g, Rectangle cellBounds, T rowObject)
        {
    ...
    [Browsable(true),
     ToolboxItem(true)]
    public class BaseRenderer<T> : AbstractRenderer<T>
    {
        ...
        /// </summary>
        [Category("Appearance"),
         Description("The image list from which keyed images will be fetched for drawing. If this is not given, the small ImageList from the ObjectListView<T> will be used"),
         DefaultValue(null)]
        ...
        public object Aspect {
            get { return aspect ?? (aspect = Column.GetValue(RowObject)); }
            set { aspect = value; }
        }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVListItem<T> ListItem { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVListSubItem<T> OLVSubItem => SubItem;
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVListSubItem<T> SubItem { get; set; }
        ...
        public Brush TextBrush {
            get
            {
                return textBrush ?? new SolidBrush(GetForegroundColor());
            }
            set { textBrush = value; }
        }
        ...
        /// <returns></returns>
        public override bool RenderItem(DrawListViewItemEventArgs e, Graphics g, Rectangle itemBounds, T model) {
        ...
        public virtual void ConfigureItem(DrawListViewItemEventArgs e, Rectangle itemBounds, T model)
        {
            ClearState();

            DrawItemEvent = e;
            ListItem = (OLVListItem<T>)e.Item;
            SubItem = null;
            ListView = (ObjectListView<T>)ListItem.ListView;
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public override bool RenderSubItem(DrawListViewSubItemEventArgs e, Graphics g, Rectangle cellBounds, T model) {
        ...
        /// <param name="model"></param>
        /// <remarks>Use this if you want to chain a second renderer within a primary renderer.</remarks>
        public virtual void ConfigureSubItem(DrawListViewSubItemEventArgs e, Rectangle cellBounds, T model) {
            ClearState();

            Event = e;
            ListItem = (OLVListItem<T>)e.Item;
            SubItem = (OLVListSubItem<T>)e.SubItem;
            ListView = (ObjectListView<T>)ListItem.ListView;
            Column = (OLVColumn<T>)e.Header;
            RowObject = model;
            Bounds = cellBounds;
            IsItemSelected = ListItem.Selected && ListItem.Enabled;
        }
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        public override void HitTest(OlvListViewHitTestInfo<T> hti, int x, int y) {
            ClearState();
        ...
        /// <param name="preferredSize"> </param>
        /// <returns></returns>
        public override Rectangle GetEditRectangle(Graphics g, Rectangle cellBounds, OLVListItem<T> item, int subItemIndex, Size preferredSize) {
            ClearState();

            ListView = (ObjectListView<T>) item.ListView;
            ListItem = item;
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected virtual void HandleHitTest(Graphics g, OlvListViewHitTestInfo<T> hti, int x, int y) {
        ...
        /// <param name="preferredSize"> </param>
        /// <returns></returns>
        protected virtual Rectangle HandleGetEditRectangle(Graphics g, Rectangle cellBounds, OLVListItem<T> item, int subItemIndex, Size preferredSize) {
            ...
            if (GetType() == typeof (BaseRenderer<T>))
        ...
        protected void StandardRender(Graphics g, Rectangle r) {
            ...
            if (ListView.ShowCellPaddingBounds)
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected virtual void StandardHitTest(Graphics g, OlvListViewHitTestInfo<T> hti, Rectangle alignedContentRectangle, int x, int y) {
            var r = alignedContentRectangle;

            // Match tweaking from renderer
            if (ColumnIsPrimary && CellHorizontalAlignment == HorizontalAlignment.Left && !(this is TreeListView<T>.TreeRenderer)) {
                r.X += 3;
                r.Width -= 1;
            }
            var width = 0;
        ...
        protected virtual bool IsCheckBoxDisabled {
            get {
                ...
                return (ListView.CellEditActivation == CellEditActivateMode.None ||
    ...
    /// </summary>
    public class HighlightTextRenderer<T> : BaseRenderer<T>, IFilterAwareRenderer<T>
    {
        ...
        public HighlightTextRenderer(TextMatchFilter<T> filter)
            : this() {
            Filter = filter;
        }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public TextMatchFilter<T> Filter { get; set; }

        /// <summary>
        /// When a filter changes, keep track of the text matching filters
        /// </summary>
        IModelFilter<T> IFilterAwareRenderer<T>.Filter
        {
            get { return Filter; }
            set { RegisterNewFilter(value); }
        }

        internal void RegisterNewFilter(IModelFilter<T> newFilter) {
            var textFilter = newFilter as TextMatchFilter<T>;
            if (textFilter != null)
            {
                Filter = textFilter;
                return;
            }
            var composite = newFilter as CompositeFilter<T>;
            if (composite != null)
            {
        ...
        /// <param name="preferredSize"> </param>
        /// <returns></returns>
        protected override Rectangle HandleGetEditRectangle(Graphics g, Rectangle cellBounds, OLVListItem<T> item, int subItemIndex, Size preferredSize) {
            return StandardGetEditRectangle(g, cellBounds, preferredSize);
        }
    ...
    public class MappedImageRenderer<T> : BaseRenderer<T>
    {
        /// <summary>
        ...
        public static MappedImageRenderer<T> Boolean(object trueImage, object falseImage) {
            return new MappedImageRenderer<T>(true, trueImage, false, falseImage);
        }
        ...
        /// <returns>A Renderer</returns>
        public static MappedImageRenderer<T> TriState(object trueImage, object falseImage, object nullImage) {
            return new MappedImageRenderer<T>(new[] {true, trueImage, false, falseImage, null, nullImage});
        }
    ...
    /// </summary>
    public class CheckStateRenderer<T> : BaseRenderer<T>
    {
        /// <summary>
        /// Draw our cell
        /// </summary>
        ...
        public override void Render(Graphics g, Rectangle r) {
            ...
            if (IsPrinting) {
                ...
                var key = ObjectListView<T>.CHECKED_KEY;
                if (state == CheckState.Unchecked)
                    key = ObjectListView<T>.UNCHECKED_KEY;
                if (state == CheckState.Indeterminate)
                    key = ObjectListView<T>.INDETERMINATE_KEY;
    ...
    /// animated.</para>
    /// </remarks>
    public class ImageRenderer<T> : BaseRenderer<T>
    {
        /// <summary>
    ...
    /// </summary>
    public class BarRenderer<T> : BaseRenderer<T>
    {
        #region Constructors
    ...
    /// </remarks>
    [ToolboxItem(false)]
    public class ImagesRenderer<T> : ImageRenderer<T> { }
    ...
    public class MultiImageRenderer<T> : BaseRenderer<T>
    {
        /// <summary>
    ...
    /// </summary>
    public class FlagRenderer<T> : BaseRenderer<T>
    {
        /// <summary>
    ...
    /// </para>
    /// </remarks>
    public class DescribedTaskRenderer<T> : BaseRenderer<T>, IFilterAwareRenderer<T>
    {
        private readonly StringFormat noWrapStringFormat;
        private readonly HighlightTextRenderer<T> highlightTextRenderer = new HighlightTextRenderer<T>();
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public TextMatchFilter<T> Filter
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public virtual string GetDescription(T model) {
            if (string.IsNullOrEmpty(DescriptionAspectName))
                return string.Empty;

            if (descriptionGetter == null)
                descriptionGetter = new Munger<T>(DescriptionAspectName);

            return descriptionGetter.GetValue(model) as string;
        }
        private Munger<T> descriptionGetter;
        ...
        /// <param name="model"></param>
        /// <remarks>Use this if you want to chain a second renderer within a primary renderer.</remarks>
        public override void ConfigureSubItem(DrawListViewSubItemEventArgs e, Rectangle cellBounds, T model) {
    ...
    /// </summary>
    public class ColumnButtonRenderer<T> : BaseRenderer<T>
    {
        ...
        public ButtonSizingMode SizingMode { get; set; } = ButtonSizingMode.TextBounds;
        ...
        protected override Size CalculateContentSize(Graphics g, Rectangle r) {
            if (SizingMode == ButtonSizingMode.CellBounds)
                return r.Size;

            if (SizingMode == ButtonSizingMode.FixedBounds)
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected override void StandardHitTest(Graphics g, OlvListViewHitTestInfo<T> hti, Rectangle bounds, int x, int y) {
        ...
        protected PushButtonState CalculatePushButtonState() {
            ...
            if (IsButtonHot)
                return ListView.IsLeftMouseDown ? PushButtonState.Pressed : PushButtonState.Hot;
