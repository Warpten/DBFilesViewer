/*
 * TypedObjectListView<T> - A wrapper around an ObjectListView<T> that provides type-safe delegates.
 *
...
{
    /// <summary>
    /// A TypedObjectListView<T> is a type-safe wrapper around an ObjectListView.
    /// </summary>
    /// <remarks>
    ...
    /// the custom OLVColumn<T>'s that we need to truly be generic. So this wrapper is an 
    /// experiment in providing some type-safe access in a way that is useful and available today.</para>
    /// <para>A TypedObjectListView<T> is not more efficient than a normal ObjectListView.
    ...
    public class TypedObjectListView<T> where T : class
    {
        ...
        public TypedObjectListView(ObjectListView<T> olv) {
            this.olv = olv;
        }
        ...
        /// <summary>
        /// The ObjectListView<T> that is being wrapped
        /// </summary>
        public virtual ObjectListView<T> ListView {
            get { return olv; }
            set { olv = value; }
        }
        private ObjectListView<T> olv;
        ...
        /// <returns></returns>
        public delegate String TypedCellToolTipGetterDelegate(OLVColumn<T> column, T modelObject);
        ...
        public virtual TypedCellToolTipGetterDelegate CellToolTipGetter {
            set {
                if (value == null)
                    ...
                    this.olv.CellToolTipGetter = delegate(OLVColumn<T> col, Object x) {
    ...
    /// <summary>
    /// A type-safe wrapper around an OLVColumn<T>
    /// </summary>
    ...
    public class TypedColumn<T> where T : class
    {
        ...
        /// </summary>
        /// <param name="column"></param>
        public TypedColumn(OLVColumn<T> column) {
            this.column = column;
        }
