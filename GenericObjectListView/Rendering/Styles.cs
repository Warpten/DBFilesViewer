...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    public class SimpleItemStyle<T> : Component, IItemStyle
    {
        /// <summary>
    ...
    /// </summary>
    public class HotItemStyle<T> : SimpleItemStyle<T>
    {
        /// <summary>
        ...
        public IOverlay<T> Overlay { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public IDecoration<T> Decoration { get; set; }
    }
