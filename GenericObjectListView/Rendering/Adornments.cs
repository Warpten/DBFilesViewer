...
{
    public interface IGraphicAdornment
    {
        ContentAlignment AdornmentCorner { get; set; }
        ContentAlignment Alignment { get; set; }
        Size Offset { get; set; }
        ContentAlignment ReferenceCorner { get; set; }
    ...
    /// </summary>
    public class GraphicAdornment<T> : IGraphicAdornment
    {
        ...
        /// <returns></returns>
        public virtual Rectangle CalculateItemBounds(OLVListItem<T> item, OLVListSubItem<T> subItem) {
            if (item == null)
    ...
    public interface IImageAdornment
    {
        Image Image { get; set; }
        bool ShrinkToWidth { get; set; }
    }

    /// <summary>
    /// An overlay that will draw an image over the top of the ObjectListView
    /// </summary>
    public class ImageAdornment<T> : GraphicAdornment<T>, IImageAdornment
    {
        #region Public properties
    ...
    public interface ITextAdornment
    {
        ...
        Font Font { get; set; }
        Font FontOrDefault { get; }
        bool HasBackground { get; }
        bool HasBorder { get; }
        int MaximumTextWidth { get; set; }
    ...
    /// </summary>
    public class TextAdornment<T> : GraphicAdornment<T>, ITextAdornment
    {
        #region Public properties
