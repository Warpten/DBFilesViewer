...
namespace BrightIdeasSoftware
{
    ...
    /// </summary>
    public interface ITransparentOverlay<T> : IOverlay<T>
    {
        /// <summary>
    ...
    /// </summary>
    public class AbstractOverlay<T> : ITransparentOverlay<T>
    {
    ...
    /// </summary>
    [TypeConverter(typeof(Design.OverlayConverter))]
    public class ImageOverlay<T> : ImageAdornment<T>, ITransparentOverlay<T>, IImageOverlay
    {
        /// <summary>
    ...
    public interface ITextOverlay
    {
        int InsetX { get; set; }
        int InsetY { get; set; }
        bool RoundCorneredBorder { get; set; }
    }
    ...
    /// </summary>
    [TypeConverter(typeof(Design.OverlayConverter))]
    public class TextOverlay<T> : TextAdornment<T>, ITransparentOverlay<T>, ITextOverlay
    {
        /// <summary>
    ...
    /// </summary>
    public class BillboardOverlay<T> : TextOverlay<T>
    {
        /// <summary>
