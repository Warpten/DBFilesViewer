...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView<T> : ListView, ISupportInitialize, IObjectListView
    {
...
// ReSharper restore DoNotCallOverridableMethodsInConstructor
        ...
        /// </summary>
        public bool IsLeftMouseDown => (MouseButtons & MouseButtons.Left) == MouseButtons.Left;
        ...
        /// </summary>
        public static TextRenderingHint TextRenderingHint { get; set; } = TextRenderingHint.SystemDefault;
        ...
        /// </remarks>
        public bool IgnoreMissingAspects => Munger<T>.IgnoreMissingAspects;
        ...
        /// </remarks>
        public bool ShowCellPaddingBounds { get; set; }

        /// <summary>
        /// Gets the style that will be used by default to format disabled rows
        /// </summary>
        public SimpleItemStyle<T> DefaultDisabledItemStyle => sDefaultDisabledItemStyle ??
                                                                  (sDefaultDisabledItemStyle = new SimpleItemStyle<T> { ForeColor = Color.DarkGray});

        private SimpleItemStyle<T> sDefaultDisabledItemStyle;

        /// <summary>
        /// Gets the style that will be used by default to format hot rows
        /// </summary>
        public HotItemStyle<T> DefaultHotItemStyle { get; set; } = new HotItemStyle<T>
        {
        ...
        public virtual IModelFilter<T> AdditionalFilter
        {
        ...
        private IModelFilter<T> additionalFilter;
        ...
        public virtual List<IOLVColumn> AllColumns { get; set; } = new List<IOLVColumn>();
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IOLVColumn AlwaysGroupByColumn { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public CellEditKeyEngine<T> CellEditKeyEngine { get; set; } = new CellEditKeyEngine<T>();
        ...
        /// </summary>
        [Browsable(false)]
        public ToolTipControl<T> CellToolTip {
            get {
                if (cellToolTip == null)
                    CreateCellToolTip();
                return cellToolTip;
        ...
        private ToolTipControl<T> cellToolTip;
        ...
        /// </para>
        /// <para>
        /// So, olv1.CellPadding = new Rectangle(1, 2, 3, 4); will leave one pixel
        ...
        public virtual T CheckedObject {
            get {
                ...
                return checkedObjects.Count == 1 ? checkedObjects[0] : default(T);
            }
            set {
                CheckedObjects = new List<T>(new[] { value });
            }
        }
        ...
        public virtual IList<T> CheckedObjects {
            ...
            set {
                ...
                Debug.WriteLine("PERF - Setting CheckedObjects on {2} objects took {0}ms / {1} ticks", sw.ElapsedMilliseconds, sw.ElapsedTicks, GetItemCount());
        ...
        /// </remarks>
        /// <example>
        /// olv1.CheckedObjectsEnumerable = olv1.Objects;
        /// </example>
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IEnumerable<T> CheckedObjectsEnumerable {
            get {
                return CheckedObjects;
            }
            set { CheckedObjects = new List<T>(value); }
        }
        ...
        /// </summary>
        [Browsable(false)]
        public virtual List<OLVColumn<T>> ColumnsInDisplayOrder {
            get {
                var columnsInDisplayOrder = new OLVColumn<T>[Columns.Count];
                foreach (OLVColumn<T> col in Columns)
                    columnsInDisplayOrder[col.DisplayIndex] = col;
                return new List<OLVColumn<T>>(columnsInDisplayOrder);
            }
        }
        ...
        /// </remarks>
        [Browsable(false)]
        protected IList<IDecoration<T>> Decorations => decorations;

        private readonly List<IDecoration<T>> decorations = new List<IDecoration<T>>();
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public IRenderer<T> DefaultRenderer { get; set; } = new HighlightTextRenderer<T>();
        ...
        public IRenderer<T> GetCellRenderer(T model, OLVColumn<T> column) {
            var renderer = CellRendererGetter?.Invoke(model, column);
        ...
        DefaultValue(null)]
        public SimpleItemStyle<T> DisabledItemStyle { get; set; }
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IList<T> DisabledObjects
        {
            get
            {
                return disabledObjects.Keys as IList<T>;
            }
            set
            {
        ...
        public void DisableObject(T model) => DisableObjects(new[] { model });

        /// <summary>
        /// Disable all the given model objects
        /// </summary>
        /// <param name="models"></param>
        public void DisableObjects(IList<T> models)
        {
            if (models == null)
                return;
        ...
        /// </summary>
        /// <param name="model">Must not be null</param>
        public void EnableObject(T model)
        {
        ...
        /// </summary>
        /// <param name="models"></param>
        public void EnableObjects(IList<T> models)
        {
            if (models == null)
                return;
            foreach (var model in models)
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public IDragSource<T> DragSource { get; set; }
        ...
        public IDropSink<T> DropSink {
            ...
            set {
                ...
                var oldSink = dropSink as SimpleDropSink<T>;
                if (oldSink != null) {
                ...
                var newSink = value as SimpleDropSink<T>;
                if (newSink != null) {
        ...
        private IDropSink<T> dropSink;

        // Forward events from the drop sink to the control itself
        void DropSinkCanDrop(object sender, OlvDropEventArgs<T> e) { OnCanDrop(e); }
        void DropSinkDropped(object sender, OlvDropEventArgs<T> e) { OnDropped(e); }
        void DropSinkModelCanDrop(object sender, ModelDropEventArgs<T> e) { OnModelCanDrop(e); }
        void DropSinkModelDropped(object sender, ModelDropEventArgs<T> e) { OnModelDropped(e); }
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        public virtual string EmptyListMsg {
            get {
                var overlay = EmptyListMsgOverlay as TextOverlay<T>;
                return overlay?.Text;
            }
            set {
                var overlay = EmptyListMsgOverlay as TextOverlay<T>;
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IOverlay<T> EmptyListMsgOverlay {
        ...
        private IOverlay<T> emptyListMsgOverlay;
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IEnumerable<T> FilteredObjects {
            get {
                if (UseFiltering)
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public FilterMenuBuilder<T> FilterMenuBuildStrategy { get; set; } = new FilterMenuBuilder<T>();
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual T FocusedObject {
            get { return ((OLVListItem<T>) FocusedItem).RowObject; }
            set {
        ...
        /// <summary>
        /// Return GroupWithItemCountFormat or a reasonable default
        /// </summary>
        [Browsable(false)]
        ...
        /// </summary>
        [Browsable(false)]
        public HeaderControl<T> HeaderControl => headerControl ?? (headerControl = new HeaderControl<T>(this));

        private HeaderControl<T> headerControl;
        ...
        /// </summary>
        [Browsable(false)]
        public ToolTipControl<T> HeaderToolTip => HeaderControl.ToolTip;
        ...
        [Category("ObjectListView"),
         ...
         DefaultValue(null)]
        public virtual HotItemStyle<T> HotItemStyle {
        ...
        private HotItemStyle<T> hotItemStyle;
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual HotItemStyle<T> HotItemStyleOrDefault => HotItemStyle ?? DefaultHotItemStyle;
        ...
        public virtual bool IsSimpleDropSink {
            ...
            set {
                DropSink = value ? new SimpleDropSink<T>() : null;
            }
        }
        ...
        public virtual bool IsSimpleDragSource {
            ...
            set {
                DragSource = value ? new SimpleDragSource<T>() : null;
            }
        }
        ...
        DefaultValue(null)]
        public IRenderer<T> ItemRenderer { get; set; }
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual OLVColumn<T> LastSortColumn {
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IListFilter<T> ListFilter {
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IModelFilter<T> ModelFilter {
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual OlvListViewHitTestInfo<T> MouseMoveHitTest { get; private set; }
        ...
        /// </para>
        /// <para>This method preserves selection, if possible. Use <see cref="SetObjects(IList, bool)"/> if
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IEnumerable<T> ObjectsForClustering => Objects;
        ...
        [Category("ObjectListView"),
         ...
         DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ImageOverlay<T> OverlayImage {
        ...
        private ImageOverlay<T> imageOverlay;
        ...
        [Category("ObjectListView"),
         ...
         DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public TextOverlay<T> OverlayText {
        ...
        private TextOverlay<T> textOverlay;
        ...
        /// </remarks>
        [Browsable(false)]
        protected IList<IOverlay<T>> Overlays => overlays;
        ...
        protected Dictionary<T, CheckState> CheckStateMap {
            get { return checkStateMap ?? (checkStateMap = new Dictionary<T, CheckState>()); }
            set { checkStateMap = value; }
        }
        private Dictionary<T, CheckState> checkStateMap;
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual OLVColumn<T> PrimarySortColumn {
            get { return primarySortColumn; }
            set {
        ...
        private OLVColumn<T> primarySortColumn;
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual OLVColumn<T> SecondarySortColumn { get; set; }
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVColumn<T> SelectedColumn {
        ...
        private OLVColumn<T> selectedColumn;
        private readonly TintedColumnDecoration<T> selectedColumnDecoration = new TintedColumnDecoration<T>();
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual IDecoration<T> SelectedRowDecoration { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual OLVListItem<T> SelectedItem {
            get {
        ...
        public virtual T SelectedObject {
            get {
                return SelectedIndices.Count == 1 ? GetModelObject(SelectedIndices[0]) : default(T);
            }
            set {
        ...
        public bool UseTranslucentSelection {
            ...
            set {
                ...
                if (value) {
                    var rbd = new RowBorderDecoration<T>();
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual BooleanCheckStateGetterDelegate<T> BooleanCheckStateGetter {
            set {
                if (value == null)
                    CheckStateGetter = null;
                else
                    CheckStateGetter = delegate(T x) {
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual BooleanCheckStatePutterDelegate<T> BooleanCheckStatePutter {
            set
            {
                if (value == null)
                    this.CheckStatePutter = null;
                else
                    this.CheckStatePutter = delegate (T x, CheckState state)
                    {
                        return value(x, state == CheckState.Checked) ? CheckState.Checked : CheckState.Unchecked;
                    };
            }
        }
        ...
        [Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual Func<T, OLVColumn<T>, IRenderer<T>> CellRendererGetter { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual Func<OLVColumn<T>, T, string> CellToolTipGetter { get; set; }
        ...
        public virtual string CheckedAspectName {
            ...
            set {
                ...
                if (string.IsNullOrEmpty(checkedAspectName)) {
                    ...
                    checkedAspectMunger = new Munger<T>(checkedAspectName);
                    CheckStateGetter = modelObject => {
                    ...
                    CheckStatePutter = delegate(T modelObject, CheckState newValue) {
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual CheckStateGetterDelegate<T> CheckStateGetter { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual CheckStatePutterDelegate<T> CheckStatePutter { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual SortDelegate<T> CustomSorter { get; set; }
        ...
        [Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual RowFormatterDelegate<T> RowFormatter { get; set; }
        ...
        public virtual void AddObject(T modelObject) {
            if (InvokeRequired)
        ...
        /// </remarks>
        public virtual void AddObjects(ICollection<T> modelObjects) {
            if (InvokeRequired) {
                Invoke((MethodInvoker)delegate { AddObjects(modelObjects); });
                return;
            }
            InsertObjects(modelObjects.Count, modelObjects);
        ...
        public virtual void AutoResizeColumns() {
            foreach (OLVColumn<T> c in Columns) {
        ...
        private BeforeSortingEventArgs<T> BuildBeforeSortingEventArgs(OLVColumn<T> column, SortOrder order) {
            ...
            var args = new BeforeSortingEventArgs<T>(
                groupBy as OLVColumn<T>, groupByOrder,
                column, order,
        ...
        public virtual void BuildList(bool shouldPreserveState) {
            ...
            IList<T> previousSelection = new List<T>();
            var previousFocus = default(T);
            if (shouldPreserveState && objects != null) {
                previousSelection = SelectedObjects;
                var focusedItem = FocusedItem as OLVListItem<T>;
                if (focusedItem != null)
            ...
            try {
                ...
                if (objectsToDisplay != null) {
                    ...
                    foreach (var rowObject in objectsToDisplay) {
                        var lvi = new OLVListItem<T>(rowObject);
            ...
            // System.Diagnostics.Debug.WriteLine(String.Format("PERF - Building list for {2} objects took {0}ms / {1} ticks", sw.ElapsedMilliseconds, sw.ElapsedTicks, GetItemCount()));
        }
        ...
        public virtual void CalculateReasonableTileSize() {
            ...
            var columns = AllColumns.Cast<OLVColumn<T>>().ToList().FindAll(x => (x.Index == 0) || x.IsTileViewColumn);

            var imageHeight = LargeImageList?.ImageSize.Height ?? 16;
        ...
        public virtual void ChangeToFilteredColumns(View view) {
            ...
            if (view == View.Details || ShowHeaderInAllViews) {
                ...
                var columnsInDisplayOrder = new List<OLVColumn<T>>(columns.Cast<OLVColumn<T>>());
...
// ReSharper disable once CoVariantArrayConversion
            Columns.AddRange(columns.Cast<OLVColumn<T>>().ToArray());
            if (view == View.Details || ShowHeaderInAllViews)
                ShowSortIndicator();
            UpdateFiltering();
            Unfreeze();
        ...
        public virtual void CopySelectionToClipboard() {
            ...
            Clipboard.SetDataObject(data ?? new OLVDataObject<T>(this, selection));
        }

        /// <summary>
        /// Copy a text and html representation of the given objects onto the clipboard.
        /// </summary>
        public virtual void CopyObjectsToClipboard(List<T> objectsToCopy) {
            ...
            var dataObject = new OLVDataObject<T>(this, objectsToCopy);
        ...
        /// </summary>
        public virtual string ObjectsToHtml(IList<T> objectsToConvert) {
            if (objectsToConvert.Count == 0)
                return string.Empty;

            var exporter = new OLVExporter<T>(this, objectsToConvert);
            return exporter.ExportTo(OLVExporter<T>.ExportFormat.HTML);
        }
        ...
        public virtual OLVListItem<T> GetNextItem(OLVListItem<T> itemToFind) {
            if (ShowGroups) {
                var isFound = (itemToFind == null);
                foreach (ListViewGroup group in Groups) {
                    foreach (OLVListItem<T> olvi in group.Items) {
                        if (isFound)
                            return olvi;
        ...
        /// </summary>
        /// <returns></returns>
        public virtual OLVListItem<T> GetLastItemInDisplayOrder() {
            if (!ShowGroups)
            ...
            if (Groups.Count > 0) {
                ...
                if (lastGroup.Items.Count > 0)
                    return (OLVListItem<T>)lastGroup.Items[lastGroup.Items.Count - 1];
            }
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        public virtual OLVListItem<T> GetNthItemInDisplayOrder(int n) {
            if (!ShowGroups || Groups.Count == 0)
                return GetItem(n);

            foreach (ListViewGroup group in Groups) {
                if (n < group.Items.Count)
                    return (OLVListItem<T>)group.Items[n];
        ...
        /// <returns>A ListViewItem</returns>
        public virtual OLVListItem<T> GetPreviousItem(OLVListItem<T> itemToFind) {
            if (ShowGroups) {
                OLVListItem<T> previousItem = null;
                foreach (ListViewGroup group in Groups) {
                    foreach (OLVListItem<T> lvi in group.Items) {
                        if (lvi == itemToFind)
                            return previousItem;
        ...
        ///</remarks>
        public virtual void InsertObjects(int index, ICollection<T> modelObjects) {
            if (InvokeRequired) {
            ...
            try {
                ...
                var ourObjects = Objects?.ToList() ?? new List<T>();
                ...
                if (IsFiltering) {
                    ...
                    foreach (var modelObject in modelObjects) {
                        if (modelObject != null) {
                            ...
                            var lvi = new OLVListItem<T>(modelObject);
        ...
        public virtual void MoveObjects(int index, ICollection<T> modelObjects) {

            // We are going to remove all the given objects from our list
            // and then insert them at the given location
            TakeOwnershipOfObjects();
            var ourObjects = modelObjects.ToList();
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        protected OlvListViewHitTestInfo<T> LowLevelHitTest(int x, int y) {

            // If it's not even in the control, don't bother with anything else
            if (!ClientRectangle.Contains(x, y))
                return new OlvListViewHitTestInfo<T>(null, null, 0, 0);

            // Is the point over the header?
            var headerHitTestInfo = HeaderControl.HitTest(x, y);
            if (headerHitTestInfo != null) 
                return new OlvListViewHitTestInfo<T>(this, headerHitTestInfo.ColumnIndex, headerHitTestInfo.IsOverCheckBox, headerHitTestInfo.OverDividerIndex);
            ...
            var hitItem = index == -1 ? null : GetItem(index);
            var subItem = (View == View.Details && hitItem != null) ? hitItem.GetSubItem(lParam.iSubItem) : null;

            var olvListViewHitTest = new OlvListViewHitTestInfo<T>(hitItem, subItem, lParam.flags, lParam.iSubItem);
        ...
        public virtual OlvListViewHitTestInfo<T> OlvHitTest(int x, int y) {
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected virtual void CalculateStandardHitTest(OlvListViewHitTestInfo<T> hti, int x, int y) {
        ...
        /// <param name="x"></param>
        /// <param name="y"></param>
        protected virtual void CalculateOwnerDrawnHitTest(OlvListViewHitTestInfo<T> hti, int x, int y) {
        ...
        public virtual void PauseAnimations(bool isPause) {
            for (var i = 0; i < Columns.Count; i++) {
                var col = GetColumn(i);
                var renderer = col.Renderer as ImageRenderer<T>;
                if (renderer != null) 
        ...
        /// </remarks>
        public virtual void RemoveObject(T modelObject) {
            if (InvokeRequired)
        ...
        /// <para>This method is thread-safe.</para>
        /// </remarks>
        public virtual void RemoveObjects(ICollection<T> modelObjects) {
            if (InvokeRequired) {
...
// ReSharper restore PossibleMultipleEnumeration
        ...
        public virtual void SetObjects(IEnumerable<T> collection) => SetObjects(collection?.ToList(), false);
        ...
        public virtual void SetObjects(IList<T> collection, bool preserveState) {
            if (InvokeRequired) {
            ...
            var args = new ItemsChangingEventArgs<T>(Objects, collection);
        ...
        /// <remarks>
        /// <para>
        /// See <see cref="RemoveObject"/> for more details
        /// </para>
        /// <para>This method is thread-safe.</para>
        /// <para>This method will cause the list to be resorted.</para>
        /// <para>This method only works on ObjectListViews and FastObjectListViews.</para>
        /// </remarks>
        public virtual void UpdateObject(T modelObject) {
            if (InvokeRequired)
                Invoke((MethodInvoker)delegate { UpdateObject(modelObject); });
            else
                UpdateObjects(new [] { modelObject });
        }
        ...
        /// <para>This method only works on ObjectListViews and FastObjectListViews.</para>
        /// </remarks>
        public virtual void UpdateObjects(IList<T> modelObjects) {
            if (InvokeRequired) {
        ...
        /// </remarks>
        [Category("ObjectListView"),
        Description("Should ObjectListView<T> listen for property changed events on the model objects?"),
        DefaultValue(false)]
        ...
        public virtual bool RestoreState(byte[] state) {
            using (var ms = new MemoryStream(state)) {
                ...
                if (olvState.SortColumn == -1) {
                    ...
                    PrimarySortColumn = AllColumns[olvState.SortColumn] as OLVColumn<T>;
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void HandleCellToolTipShowing(object sender, ToolTipShowingEventArgs<T> e) {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        internal void HeaderToolTipShowingCallback(object sender, ToolTipShowingEventArgs<T> e) {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void HandleHeaderToolTipShowing(object sender, ToolTipShowingEventArgs<T> e) {
        ...
        protected virtual bool HandleCustomDraw(ref Message m) {
            ...
            switch (nmcustomdraw.nmcd.dwDrawStage) {
                case CDDS_PREPAINT:
                    ...
                    if (prePaintLevel == 0)
                        drawnItems = new List<OLVListItem<T>>();
        ...
        protected virtual int FindMatchInRange(string text, int first, int last, OLVColumn<T> column) {
            if (first <= last) {
        ...
        /// <param name="hti"></param>
        /// <returns>True if the message has been handled</returns>
        protected virtual bool ProcessLButtonDown(OlvListViewHitTestInfo<T> hti) {
            ...
            if (MouseMoveHitTest.HitTestLocation == HitTestLocation.Button) {
                ...
                if (MouseMoveHitTest.Item.Enabled || MouseMoveHitTest.Column.EnableButtonWhenItemIsDisabled) {
                    ...
                    if (!string.IsNullOrEmpty(buttonText)) {
                        Invalidate();
                        var args = new CellClickEventArgs<T>();
        ...
        /// <param name="hti"></param>
        /// <returns>True if the message has been handled</returns>
        protected virtual bool ProcessRButtonDown(OlvListViewHitTestInfo<T> hti) {
            if (hti.Item == null)
                return false;
        ...
        /// <param name="hti"></param>
        /// <returns>True if the message has been handled</returns>
        protected virtual bool ProcessLButtonDoubleClick(OlvListViewHitTestInfo<T> hti) {
        ...
        /// <param name="hti"></param>
        /// <returns>True if the message has been handled</returns>
        protected virtual bool ProcessRButtonDoubleClick(OlvListViewHitTestInfo<T> hti) {
                            ...
                            if (isSelected)
                            {
                               // System.Diagnostics.Debug.WriteLine(String.Format("Selected: {0}", nmlistviewPtr2.iItem));
                                ...
                                if (nmlistviewPtr2.iItem == -1 || isShiftDown) {
                                    ...
                                    Debug.WriteLine("PERF - Deselecting took {0}ms / {1} ticks", sw.ElapsedMilliseconds, sw.ElapsedTicks);
                                }
                                else
                                {
        ...
        protected bool HandleNotify(ref Message m) {
            ...
            switch (nmheader.nhdr.code) {
                ...
                case ToolTipControl<T>.TTN_SHOW:
...
//                    break;
        ...
        protected virtual void CreateCellToolTip() {
            cellToolTip = new ToolTipControl<T>();
        ...
        protected virtual void HandlePrePaint() {
            ...
            // lastUpdateRectangle = NativeMethods.GetUpdateRect(this); // we no longer need this, but keep the code so we can see it later

            //// When the list is empty, we want to handle the drawing of the control by ourselves.
            //// Unfortunately, there is no easy way to tell our superclass that we want to do 
        ...
        public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex) {
            ...
            if (column.Sortable && !string.IsNullOrEmpty(label)) {
                strip.Items.Add(label, SortAscendingImage, delegate {
                                                                        Sort(column, SortOrder.Ascending);
                });
            }
            label = string.Format(MenuLabelSortDescending, column.Text);
            if (column.Sortable && !string.IsNullOrEmpty(label)) {
                strip.Items.Add(label, SortDescendingImage, delegate {
        ...
        public virtual ToolStripDropDown MakeColumnSelectMenu(ToolStripDropDown strip) {
            ...
            if (SelectColumnsOnRightClickBehaviour == ColumnSelectBehaviour.ModelDialog) {
                strip.Items.Add(MenuLabelSelectColumns, null, delegate {
                    (new ColumnSelectionForm<T>()).OpenOn(this);
                });
            }
        ...
        protected void AddItemsToColumnSelectMenu(ToolStripItemCollection items) {
            ...
            var columns = new List<OLVColumn<T>>(AllColumns.Cast<OLVColumn<T>>());
        ...
        private void ColumnSelectMenuItemClicked(object sender, ToolStripItemClickedEventArgs e) {
            ...
            var col = menuItemClicked?.Tag as OLVColumn<T>;
            if (col == null)
                return;
        ...
        private void RememberDisplayIndicies() {
            ...
            foreach (OLVColumn<T> x in AllColumns)
        ...
        private void RunWhenIdle(EventHandler eventHandler) {
            ...
            if (!CanUseApplicationIdle) {
                SynchronizationContext.Current.Post(delegate { Application.RaiseIdle(EventArgs.Empty); }, null);
            }
        }
        ...
        protected virtual void ResizeFreeSpaceFillingColumns(int freeSpace) {
            ...
            var spaceFillingColumns = new List<OLVColumn<T>>();
            for (var i = 0; i < Columns.Count; i++) {
                var col = GetColumn(i);
        ...
        {
            CheckedObjects = Objects.ToArray();
        }
        ...
        /// <param name="column"></param>
        public virtual void CheckHeaderCheckBox(OLVColumn<T> column)
        {
            if (column == null)
                return;
        ...
        /// </summary>
        /// <param name="column"></param>
        public virtual void CheckIndeterminateHeaderCheckBox(OLVColumn<T> column)
        {
            if (column == null)
                return;
        ...
        public virtual void CheckIndeterminateObject(T modelObject) {
        ...
        public virtual void CheckObject(T modelObject) {
        ...
        public virtual void CheckObjects(IEnumerable<T> modelObjects) {
        ...
        /// <param name="column"></param>
        public virtual void CheckSubItem(T rowObject, OLVColumn<T> column) {
        ...
        /// <param name="rowObject"></param>
        /// <param name="column"></param>
        public virtual void CheckIndeterminateSubItem(T rowObject, OLVColumn<T> column) {
            if (column == null || rowObject == null || !column.CheckBoxes)
                return;
        ...
        public virtual bool IsChecked(T modelObject) {
        ...
        /// <remarks>If the given object is not in the list, this method returns false.</remarks>
        public virtual bool IsCheckedIndeterminate(T modelObject) {
        ...
        /// <param name="rowObject"></param>
        /// <param name="column"></param>
        public virtual bool IsSubItemChecked(T rowObject, OLVColumn<T> column) {
            if (column == null || rowObject == null || !column.CheckBoxes) 
                return false;
        ...
        /// <returns></returns>
        protected virtual CheckState? GetCheckState(T modelObject) {
        ...
        /// the control.</returns>
        protected virtual CheckState PutCheckState(T modelObject, CheckState state) {
        ...
        protected virtual bool SetObjectCheckedness(T modelObject, CheckState state) {
        ...
        /// </summary>
        /// <param name="modelObject">The model object to be checked</param>
        public virtual void ToggleCheckObject(T modelObject) {
            var olvi = ModelToItem(modelObject);
            if (olvi == null)
                return;
        ...
        /// <param name="column"></param>
        public virtual void ToggleHeaderCheckBox(OLVColumn<T> column) {
            if (column == null)
                return;
        ...
        private void ChangeHeaderCheckBoxState(OLVColumn<T> column, CheckState newState) {
            // Tell the world the checkbox was clicked
            var args = new HeaderCheckBoxChangingEventArgs<T>();
            args.Column = column;
            ...
            Debug.WriteLine("PERF - Changing row checkboxes on {2} objects took {0}ms / {1} ticks", sw.ElapsedMilliseconds, sw.ElapsedTicks, GetItemCount());
        }

        private void UpdateAllPrimaryCheckBoxes(OLVColumn<T> column) {
        ...
        private void UpdateAllSubItemCheckBoxes(OLVColumn<T> column) {
        ...
        /// <param name="rowObject"></param>
        /// <param name="column"></param>
        public virtual void ToggleSubItemCheckBox(T rowObject, OLVColumn<T> column) {
            ...
            var args = new SubItemCheckingEventArgs<T>(column, ModelToItem(rowObject), column.Index, currentState, newState);
        ...
        public virtual void UncheckObject(T modelObject) {
        ...
        /// </summary>
        /// <param name="modelObjects">The model object to be checked</param>
        public virtual void UncheckObjects(IList<T> modelObjects) {
            foreach (var model in modelObjects)
                UncheckObject(model);
        }
        ...
        /// </summary>
        /// <param name="column"></param>
        public virtual void UncheckHeaderCheckBox(OLVColumn<T> column)
        {
            if (column == null)
                return;
        ...
        /// <param name="rowObject"></param>
        /// <param name="column"></param>
        public virtual void UncheckSubItem(T rowObject, OLVColumn<T> column)
        {
            if (column == null || rowObject == null || !column.CheckBoxes)
                return;
        ...
        public virtual List<IOLVColumn> GetFilteredColumns(View view) {
            ...
            var index = 0;
            return AllColumns.FindAll(x => (index++ == 0) || x.IsVisible).Cast<IOLVColumn>().ToList();
        }
        ...
        public virtual OLVListItem<T> GetItem(int index) {
            if (index < 0 || index >= GetItemCount()) 
                return null;
            
            return (OLVListItem<T>)Items[index];
        }
        ...
        public virtual T GetModelObject(int index) {
            ...
            return item == null ? default(T) : item.RowObject;
        }
        ...
        public virtual OLVListItem<T> GetItemAt(int x, int y, out OLVColumn<T> hitColumn) {
            hitColumn = null;
            ...
            return (OLVListItem<T>)info.Item;
        }
        ...
        public virtual OLVListSubItem<T> GetSubItem(int index, int columnIndex) {
        ...
        public virtual void EnsureModelVisible(T modelObject) {
        ...
        public virtual int IndexOf(T modelObject) {
            for (var i = 0; i < GetItemCount(); i++) {
        ...
        public virtual void RefreshItem(OLVListItem<T> olvi) {
        ...
        /// </para>
        /// </remarks>
        public virtual void RefreshObject(T modelObject) {
        ...
        /// </remarks>
        public virtual void RefreshObjects(IList<T> modelObjects) {
            if (InvokeRequired) {
        ...
        private void ReplaceModel(OLVListItem<T> olvi, T newModel) {
            if (ReferenceEquals(olvi.RowObject, newModel))
                return;

            TakeOwnershipOfObjects();
            var array = Objects.ToArray();
            var i = Array.IndexOf(array, olvi.RowObject);
            if (i >= 0)
                array[i] = newModel;
        ...
        public virtual void SelectObject(T modelObject) {
        ...
        /// <remarks>Use the <see cref="SelectedObject"/> property to deselect all other rows</remarks>
        public virtual void SelectObject(T modelObject, bool setFocus) {
            var olvi = ModelToItem(modelObject);
            if (olvi != null && olvi.Enabled) {
                olvi.Selected = true;
                if (setFocus)
        ...
        /// </summary>
        /// <param name="modelObjects">A collection of model objects</param>
        public virtual void SelectObjects(IList<T> modelObjects) {
            SelectedIndices.Clear();
        ...
        private class SuspendSelectionDisposable : IDisposable {
            public SuspendSelectionDisposable(ObjectListView<T> objectListView) {
                this.objectListView = objectListView;
                objectListView.SuspendSelectionEvents();
            }
            ...
            private readonly ObjectListView<T> objectListView;
        }
        ...
        public virtual void Sort(OLVColumn<T> columnToSort) {
            if (InvokeRequired) {
        ...
        /// Sorting and then SortOrder.Ascending will be used</param>
        ...
        public virtual void Sort(OLVColumn<T> columnToSort, SortOrder order) {
            if (InvokeRequired) {
        ...
        private void DoSort(OLVColumn<T> columnToSort, SortOrder order) {
            // Sanity checks
            ...
            if (!args.Handled) {
                ...
                if (args.ColumnToSort != null && args.SortOrder != SortOrder.None) {
                    if (CustomSorter != null)
                        ...
                        ListViewItemSorter = new ColumnComparer<T>(args.ColumnToSort, args.SortOrder,
            ...
            OnAfterSorting(new AfterSortingEventArgs<T>(args));
        }
        ...
        protected virtual void ShowSortIndicator(OLVColumn<T> columnToSort, SortOrder sortOrder) {
            var imageIndex = -1;
        ...
        private OLVListSubItem<T> MakeSubItem(T rowObject, OLVColumn<T> column) {
            var cellValue = column.GetValue(rowObject);
            var subItem = new OLVListSubItem<T>(cellValue, cellValue.ToString(), column.GetImage(rowObject));
            if (UseHyperlinks && column.Hyperlink) {
                var args = new IsHyperlinkEventArgs<T>
                {
                    ListView = this,
                    Model = rowObject,
                    Column = column,
        ...
        private void ApplyHyperlinkStyle(OLVListItem<T> olvi) {
        ...
        public virtual string GetCellToolTip(int columnIndex, int rowIndex) {
            ...
            if (columnIndex >= 0) {
                ...
                if (!string.IsNullOrEmpty(subItem?.Url) && subItem.Url != subItem.Text && HotCellHitLocation == HitTestLocation.Text)
                    return subItem.Url;
            }
        ...
        public virtual OLVListItem<T> ModelToItem(T modelObject) {
            ...
            foreach (OLVListItem<T> olvi in Items) {
...
#pragma warning restore 168
            ...
            var i = 0;
            if (ShowGroups) {
                foreach (var olvi in from ListViewGroup @group in Groups from OLVListItem<T> olvi in @group.Items select olvi)
                {
        ...
        /// </summary>
        protected virtual void PostProcessOneRow(int rowIndex, int displayIndex, OLVListItem<T> olvi) {
        ...
        protected virtual void SetSubItemImages(int rowIndex, OLVListItem<T> item) {
        ...
        protected virtual void SetSubItemImages(int rowIndex, OLVListItem<T> item, bool shouldClearImages) {
        ...
        public virtual void SetSubItemImage(int rowIndex, int subItemIndex, OLVListSubItem<T> subItem, bool shouldClearImages) {
        ...
        protected virtual bool TriggerFormatRowEvent(int rowIndex, int displayIndex, OLVListItem<T> olvi) {
            var args = new FormatRowEventArgs<T>();
            args.ListView = this;
        ...
        /// <param name="displayIndex"></param>
        /// <param name="olvi"></param>
        protected virtual void TriggerFormatCellEvents(int rowIndex, int displayIndex, OLVListItem<T> olvi) {

            PropagateFormatFromRowToCells(olvi);

            // Fire one event per cell
            var args2 = new FormatCellEventArgs<T>();
            args2.ListView = this;
        ...
        private static void PropagateFormatFromRowToCells(OLVListItem<T> olvi) {
            ...
            var font = olvi.Font;
            foreach (OLVListSubItem<T> subitem in olvi.SubItems) {
        ...
        private void SetupBaseImageList() {
            ...
            if (rowHeight == -1 ||
                ...
                var width = shadowedImageList?.ImageSize.Width ?? 16;
        ...
        protected override void OnDrawItem(DrawListViewItemEventArgs e) {
            if (View == View.Details)
                ...
                if (ItemRenderer == null)
                    ...
                    var row = ((OLVListItem<T>)e.Item).RowObject;
        ...
        protected override void OnDrawSubItem(DrawListViewSubItemEventArgs e) {
            ...
            var rowObject = ((OLVListItem<T>)e.Item).RowObject;
        ...
        internal void HandleMouseMove(Point pt) {
            ...
            var args = new CellOverEventArgs<T>();
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void ProcessHyperlinkClicked(CellClickEventArgs<T> e) {
            var args = new HyperlinkClickedEventArgs<T>();
        ...
        protected virtual void StandardHyperlinkClickedProcessing(HyperlinkClickedEventArgs<T> args) {
        ...
        protected virtual void OnRightMouseUp(MouseEventArgs e) {
            var args = new CellRightClickEventArgs<T>();
            BuildCellEvent(args, e.Location);
        ...
        internal void BuildCellEvent(CellEventArgs<T> args, Point location) {
            BuildCellEvent(args, location, OlvHitTest(location.X, location.Y));
        }

        internal void BuildCellEvent(CellEventArgs<T> args, Point location, OlvListViewHitTestInfo<T> hitTest) {
        ...
        protected override bool ProcessDialogKey(Keys keyData) {
            ...
            if (keyData == Keys.F2) {
                EditSubItem((OLVListItem<T>)FocusedItem, 0);
        ...
        /// </para>
        /// </remarks>
        public virtual void EditModel(T rowModel) {
        ...
        public virtual void EditSubItem(OLVListItem<T> item, int subItemIndex) {
            if (item == null)
                return;
        ...
        /// <param name="item">The row to be edited</param>
        /// <param name="subItemIndex">The index of the cell to be edited</param>
        public virtual void StartCellEdit(OLVListItem<T> item, int subItemIndex) {
            ...
            CellEditEventArgs = new CellEditEventArgs<T>(column, c, cellBounds, item, subItemIndex);
        ...
        internal CellEditEventArgs<T> CellEditEventArgs;
        ...
        /// <returns></returns>
        public Rectangle CalculateCellEditorBounds(OLVListItem<T> item, int subItemIndex, Size preferredSize) {
        ...
        protected Rectangle CalculateCellEditorBoundsOwnerDrawn(OLVListItem<T> item, int subItemIndex, Rectangle r, Size preferredSize) {
            var renderer = View == View.Details
        ...
        /// <param name="preferredSize"> </param>
        /// <returns>A rectangle that is the bounds of the cell editor</returns>
        protected Rectangle CalculateCellEditorBoundsStandard(OLVListItem<T> item, int subItemIndex, Rectangle cellBounds, Size preferredSize) {
            if (View == View.Tile)
                return cellBounds;
        ...
        protected virtual void SetControlValue(Control control, object value, string stringValue) {
            ...
            // TODO FIX ME
            /*if (Munger<T>.PutProperty(control, "Value", value))
                return;*/
        ...
        public virtual Rectangle CalculateCellBounds(OLVListItem<T> item, int subItemIndex) {
        ...
        /// <param name="subItemIndex">The index of the cell to be edited</param>
        /// <returns>A Rectangle</returns>
        public virtual Rectangle CalculateCellTextBounds(OLVListItem<T> item, int subItemIndex) {
            return CalculateCellBounds(item, subItemIndex, ItemBoundsPortion.ItemOnly);
        }

        private Rectangle CalculateCellBounds(OLVListItem<T> item, int subItemIndex, ItemBoundsPortion portion) {
        ...
        public virtual Rectangle CalculateColumnVisibleBounds(Rectangle bounds, OLVColumn<T> column)
        {
            // Sanity checks
            if (column == null ||
                View != View.Details ||
        ...
        protected virtual Control GetCellEditor(OLVListItem<T> item, int subItemIndex) {
            var column = GetColumn(subItemIndex);
        ...
        internal object GetFirstNonNullValue(OLVColumn<T> column) {
        ...
        /// <returns></returns>
        protected virtual Control MakeDefaultCellEditor(OLVColumn<T> column) {
            var tb = new TextBox();
        ...
        public void ConfigureAutoComplete(TextBox tb, OLVColumn<T> column) {
        ...
        public void ConfigureAutoComplete(TextBox tb, OLVColumn<T> column, int maxRows) {
        ...
        /// <param name="hti"></param>
        /// <remarks>This is the main entry point for hot item handling</remarks>
        protected virtual void UpdateHotItem(OlvListViewHitTestInfo<T> hti) {
        ...
        /// </summary>
        /// <param name="olvi"></param>
        protected virtual void UpdateHotRow(OLVListItem<T> olvi) {
        ...
        /// <param name="olvi"></param>
        protected virtual void UpdateHotRow(int rowIndex, int columnIndex, HitTestLocation hitLocation, OLVListItem<T> olvi) {
        ...
        public virtual void ApplyRowStyle(OLVListItem<T> olvi, IItemStyle style) {
            if (style == null)
                return;
        ...
        /// <param name="columnIndex"></param>
        /// <param name="style"></param>
        protected virtual void ApplyCellStyle(OLVListItem<T> olvi, int columnIndex, IItemStyle style) {
            if (style == null)
                return;
        ...
        protected virtual void UnapplyHotItem(int index) {
            ...
            if (VirtualMode) {
                ...
                var olvi = GetItem(index);
                if (olvi != null) {
                    //PostProcessOneRow(index, index, olvi);
                    RefreshItem(olvi);
                }
            }
        }
        ...
        protected override void OnItemDrag(ItemDragEventArgs e) {
            ...
            var data = DragSource?.StartDrag(this, e.Button, (OLVListItem<T>)e.Item);
            if (data == null)
                return;
        ...
        /// </remarks>
        public virtual void AddDecoration(IDecoration<T> decoration) {
            if (decoration == null)
                return;
        ...
        public virtual void AddOverlay(IOverlay<T> overlay) {
            if (overlay == null)
                return;
        ...
        protected virtual void DrawAllDecorations(Graphics g, List<OLVListItem<T>> itemsThatWereRedrawn) {
            g.TextRenderingHint = TextRenderingHint;
            g.SmoothingMode = SmoothingMode;
        ...
        public virtual bool HasDecoration(IDecoration<T> decoration) {
        ...
        /// </summary>
        /// <param name="overlay">The overlay</param>
        public virtual bool HasOverlay(IOverlay<T> overlay) {
        ...
        protected virtual void InitializeStandardOverlays() {
            OverlayImage = new ImageOverlay<T>();
            AddOverlay(OverlayImage);
            OverlayText = new TextOverlay<T>();
        ...
        public virtual void ShowOverlays() {
            ...
            if (Overlays.Count != glassPanels.Count) {
                foreach (var overlay in Overlays) {
                    ...
                    if (glassPanel == null) {
                        glassPanel = new GlassPanelForm<T>();
        ...
        private GlassPanelForm<T> FindGlassPanelForOverlay(IOverlay<T> overlay)
        {
            return glassPanels.Find(x => x.Overlay == overlay);
        }
        ...
        /// </summary>
        public virtual void RefreshOverlay(IOverlay<T> overlay) {
            var glassPanel = FindGlassPanelForOverlay(overlay);
            glassPanel?.Invalidate();
        }
        ...
        public virtual void RemoveDecoration(IDecoration<T> decoration) {
            if (decoration == null)
                return;
        ...
        /// </summary>
        /// <param name="overlay">The overlay</param>
        public virtual void RemoveOverlay(IOverlay<T> overlay) {
            if (overlay == null)
                return;
        ...
        /// </summary>
        public virtual IModelFilter<T> CreateColumnFilter() {
            var filters = Columns.Cast<OLVColumn<T>>().Select(column => column.ValueBasedFilter).Where(filter => filter != null).ToList();
            return (filters.Count == 0) ? null : new CompositeAllFilter<T>(filters);
        }
        ...
        /// <returns></returns>
        protected virtual IEnumerable<T> FilterObjects(IList<T> originalObjects, IModelFilter<T> aModelFilter, IListFilter<T> aListFilter) {
            // Being cautious
            originalObjects = originalObjects ?? new List<T>();

            // Tell the world to filter the objects. If they do so, don't do anything else
            var args = new FilterEventArgs<T>(originalObjects);
            OnFilter(args);
            ...
            {
                var filteredObjects = originalObjects.Where(aModelFilter.Filter).ToList();
        ...
        public virtual void ResetColumnFiltering() {
            foreach (OLVColumn<T> column in Columns) {
        ...
        public virtual void UpdateColumnFiltering() {
            ...
            else
            {
                ...
                {
                    var filters = new List<IModelFilter<T>> {columnFilter, AdditionalFilter};
                    ModelFilter = new CompositeAllFilter<T>(filters);
                }
            }
        }
        ...
        /// </summary>
        public virtual void UpdateFiltering() {
            BuildList(true);
        }
        ...
        protected virtual void NotifyNewModelFilter() {
            var filterAware = DefaultRenderer as IFilterAwareRenderer<T>;
            if (filterAware != null)
                filterAware.Filter = ModelFilter;

            foreach (OLVColumn<T> column in AllColumns) {
                filterAware = column.Renderer as IFilterAwareRenderer<T>;
                if (filterAware != null)
                    filterAware.Filter = ModelFilter;
            }
        }
        ...
        protected virtual CheckState GetPersistentCheckState(T model) {
            CheckState state;
        ...
        protected virtual CheckState SetPersistentCheckState(T model, CheckState state) {
            if (model == null)
                return CheckState.Unchecked;
        ...
        private readonly List<GlassPanelForm<T>> glassPanels = new List<GlassPanelForm<T>>(); // The transparent panel that draws overlays
