...
namespace BrightIdeasSoftware
{
    ...
    internal static class NativeMethods
    {
        ...
        public static Point GetColumnSides<T>(ObjectListView<T> lv, int columnIndex) {
        ...
        public static void SetSelectedColumn(ListView objectListView, ColumnHeader value) {
            SendMessage(objectListView.Handle,
                LVM_SETSELECTEDCOLUMN, value?.Index ?? -1, 0);
        }
        ...
        public static IntPtr SetTooltipControl<T>(ListView lv, ToolTipControl<T> tooltip) {
        ...
        public static int GetGroupInfo<T>(ObjectListView<T> olv, int groupId, ref LVGROUP2 group) {
            return (int)SendMessage(olv.Handle, LVM_GETGROUPINFO, groupId, ref group);
        }

        public static GroupState GetGroupState<T>(ObjectListView<T> olv, int groupId, GroupState mask) {
            return (GroupState)SendMessage(olv.Handle, LVM_GETGROUPSTATE, groupId, (int)mask);
        }

        public static int InsertGroup<T>(ObjectListView<T> olv, LVGROUP2 group) {
            return (int)SendMessage(olv.Handle, LVM_INSERTGROUP, -1, ref group);
        }

        public static int SetGroupInfo<T>(ObjectListView<T> olv, int groupId, LVGROUP2 group) {
            return (int)SendMessage(olv.Handle, LVM_SETGROUPINFO, groupId, ref group);
        }

        public static int SetGroupMetrics<T>(ObjectListView<T> olv, LVGROUPMETRICS metrics) {
            return (int)SendMessage(olv.Handle, LVM_SETGROUPMETRICS, 0, ref metrics);
        }

        public static void ClearGroups<T>(VirtualObjectListView<T> virtualObjectListView) {
            SendMessage(virtualObjectListView.Handle, LVM_REMOVEALLGROUPS, 0, 0);
        }

        public static void SetGroupImageList<T>(ObjectListView<T> olv, ImageList il) {
        ...
        public static int HitTest<T>(ObjectListView<T> olv, ref LVHITTESTINFO hittest)
        {
