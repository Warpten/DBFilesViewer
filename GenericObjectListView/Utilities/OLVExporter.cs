/*
 * OLVExporter - Export the contents of an ObjectListView<T> into various text-based formats
 *
...
namespace BrightIdeasSoftware {
    ...
    public class OLVExporter<T>
    {
        ...
        public OLVExporter(ObjectListView<T> olv) : this(olv, olv.Objects) {}
        ...
        private ObjectListView<T> objectListView;

        /// <summary>
        /// Gets the model objects that are to be placed in the data object
        /// </summary>
        public IList<T> ModelObjects {
            get { return modelObjects; }
            set { modelObjects = value; }
        }
        private IList<T> modelObjects = new List<T>();
        ...
        public void Convert() {
            ...
            IList<OLVColumn<T>> columns = IncludeHiddenColumns ? ListView.AllColumns.Cast<OLVColumn<T>>().ToList() : ListView.ColumnsInDisplayOrder;
            ...
            foreach (var modelObject in ModelObjects) {
                var strings = columns.Select(col => col.GetStringValue(modelObject)).ToList();
