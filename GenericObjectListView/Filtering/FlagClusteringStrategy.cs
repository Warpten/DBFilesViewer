...
namespace BrightIdeasSoftware {
    ...
    /// </summary>
    public class FlagClusteringStrategy<T> : ClusteringStrategy<T>
    {
        ...
        /// <returns></returns>
        public override IModelFilter<T> CreateFilter(IList<T> valuesChosenForFiltering) {
            return new FlagBitSetFilter<T>(valuesChosenForFiltering);
        }
